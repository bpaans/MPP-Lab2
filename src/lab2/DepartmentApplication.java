...
public class DepartmentApplication
   ...
   public static void main(String[] args) throws IOException
      ...
      //  create the objects that you need.
		...
		Faculty frankMoore = new Faculty("Frank Moore","472-5921",43,5000);	
		Faculty samHoward = new Faculty("Sam Howard","472-7222",55,6000);
		Faculty johnDoodle = new Faculty("John Doodle","472-6190",39,8000);
		...
		Staff frankGore = new Staff("Frank Gore","472-3321",33,4000);
		Staff adamDavis = new Staff("Adam Davis","472-7552",50,5000);
		Staff davidHeck = new Staff("David Heck","472-8890",29,3000);
